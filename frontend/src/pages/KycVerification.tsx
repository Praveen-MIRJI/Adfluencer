...
import { Shield, CheckCircle, Clock, Lock, FileText, User, Award } from 'lucide-react';
      ...
      >
        ...
        <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-600/50 backdrop-blur-sm rounded-2xl shadow-2xl shadow-black/20 overflow-hidden">
          ...
          <div className="relative p-8 md:p-12 text-center">
            ...
            >
              We're building a comprehensive KYC verification system to enhance trust and security on our platform.
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-sm text-slate-400">
                  Secure upload and verification of government-issued ID documents
                </p>
              </motion.div>
              ...
              >
                ...
                <h4 className="text-lg font-semibold text-white mb-2">Identity Confirmation</h4>
                <p className="text-sm text-slate-400">
                  Advanced verification process to confirm your identity
                </p>
              </motion.div>
              ...
              <motion.div
                ...
                className="bg-slate-800/50 border border-slate-600/50 rounded-xl p-6 hover:border-green-500/50 transition-all duration-300"
              >
                ...
                <p className="text-sm text-slate-400">
                  Get a verified badge to build trust with other users
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="p-8 md:p-12 border-t border-slate-600/50">
            <h3 className="text-xl font-semibold text-white mb-6 text-center">Benefits of KYC Verification</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto">
              {[
                'Enhanced account security',
                'Increased trust from clients and influencers',
          ...
          <div className="p-6 bg-slate-900/50 border-t border-slate-600/50 text-center">
            <div className="flex items-center justify-center space-x-2 text-slate-400">
              ...
              <span className="text-sm">Your data will be encrypted and securely stored</span>
            </div>
          </div>
        </div>
