    ...
    <div className="space-y-4 sm:space-y-6 w-full max-w-full overflow-x-hidden box-border">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 sm:gap-4 lg:gap-6">
          ...
          <div className="flex gap-2 sm:gap-3 lg:gap-4 flex-shrink-0">
            <div className="bg-slate-700/50 backdrop-blur rounded-xl px-2 sm:px-3 lg:px-6 py-2 sm:py-3 lg:py-4 text-center flex-1 min-w-0">
              <p className="text-lg sm:text-xl lg:text-3xl font-bold">{stats?.totalBids || 0}</p>
              <p className="text-slate-400 text-[10px] sm:text-xs lg:text-sm truncate">Pending Bids</p>
            </div>
            <div className="bg-slate-700/50 backdrop-blur rounded-xl px-2 sm:px-3 lg:px-6 py-2 sm:py-3 lg:py-4 text-center flex-1 min-w-0">
              <p className="text-lg sm:text-xl lg:text-3xl font-bold">{stats?.activeAds || 0}</p>
              <p className="text-slate-400 text-[10px] sm:text-xs lg:text-sm truncate">Active Campaigns</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 lg:gap-4">
          ...
          <CardContent className="p-2 sm:p-3 lg:p-4">
            <div className="flex items-center gap-2 lg:gap-3">
              <div className="w-7 h-7 sm:w-8 sm:h-8 lg:w-10 lg:h-10 rounded-lg bg-slate-700 flex items-center justify-center flex-shrink-0">
                <Megaphone className="w-3.5 h-3.5 sm:w-4 sm:h-4 lg:w-5 lg:h-5 text-slate-300" />
              </div>
              <div className="min-w-0">
                <p className="text-lg sm:text-xl lg:text-2xl font-bold text-white">{stats?.totalAds || 0}</p>
                <p className="text-[10px] sm:text-xs lg:text-sm text-slate-400 truncate">Total Campaigns</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-2 sm:p-3 lg:p-4">
            <div className="flex items-center gap-2 lg:gap-3">
              <div className="w-7 h-7 sm:w-8 sm:h-8 lg:w-10 lg:h-10 rounded-lg bg-green-500/20 flex items-center justify-center flex-shrink-0">
                <FileText className="w-3.5 h-3.5 sm:w-4 sm:h-4 lg:w-5 lg:h-5 text-green-400" />
              </div>
              <div className="min-w-0">
                <p className="text-lg sm:text-xl lg:text-2xl font-bold text-white">{stats?.activeAds || 0}</p>
          ...
          <CardContent className="p-2 sm:p-3 lg:p-4">
            <div className="flex items-center gap-2 lg:gap-3">
              <div className="w-7 h-7 sm:w-8 sm:h-8 lg:w-10 lg:h-10 rounded-lg bg-blue-500/20 flex items-center justify-center flex-shrink-0">
                <Users className="w-3.5 h-3.5 sm:w-4 sm:h-4 lg:w-5 lg:h-5 text-blue-400" />
              </div>
              <div className="min-w-0">
        ...
        <Card>
          <CardContent className="p-2 sm:p-3 lg:p-4">
            <div className="flex items-center gap-2 lg:gap-3">
              <div className="w-7 h-7 sm:w-8 sm:h-8 lg:w-10 lg:h-10 rounded-lg bg-purple-500/20 flex items-center justify-center flex-shrink-0">
                <CheckCircle className="w-3.5 h-3.5 sm:w-4 sm:h-4 lg:w-5 lg:h-5 text-purple-400" />
              </div>
              <div className="min-w-0">
                <p className="text-lg sm:text-xl lg:text-2xl font-bold text-white">{stats?.closedAds || 0}</p>
                <p className="text-[10px] sm:text-xs lg:text-sm text-slate-400 truncate">Completed</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6 w-full min-w-0">
        ...
        <div className="lg:col-span-2 min-w-0">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between gap-2">
              <h2 className="text-sm sm:text-base lg:text-lg font-semibold text-white truncate">Recent Campaigns</h2>
              <Link to="/client/my-ads" className="text-xs sm:text-sm text-slate-400 hover:text-white flex items-center gap-1 flex-shrink-0">
        ...
        <div className="space-y-3 sm:space-y-4 lg:space-y-6 min-w-0">
          <Card>
            ...
            <CardContent className="space-y-2 p-3 sm:p-4 pt-0 sm:pt-0">
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="font-medium text-white text-xs sm:text-sm lg:text-base truncate">Post Campaign</p>
                  <p className="text-[10px] sm:text-xs text-rose-200 truncate">Create new ad</p>
                </div>
              </Link>
              <Link
                to="/client/discover"
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="font-medium text-white text-xs sm:text-sm lg:text-base truncate">Find Influencers</p>
                  <p className="text-[10px] sm:text-xs text-slate-400 truncate">Browse creators</p>
                </div>
              </Link>
              <Link
                to="/client/contracts"
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="font-medium text-white text-xs sm:text-sm lg:text-base truncate">Contracts</p>
                  <p className="text-[10px] sm:text-xs text-slate-400 truncate">Manage deals</p>
                </div>
              </Link>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader className="p-3 sm:p-4">
              <h2 className="text-sm sm:text-base lg:text-lg font-semibold text-white">Performance</h2>
            </CardHeader>
            <CardContent className="p-3 sm:p-4 pt-0 sm:pt-0">
              <div className="space-y-3 sm:space-y-4">
                <div>
                  <div className="flex justify-between text-[10px] sm:text-xs lg:text-sm mb-1 gap-2">
                    <span className="text-slate-400 truncate">Bid Response Rate</span>
                    <span className="font-medium text-white text-[10px] sm:text-xs lg:text-sm flex-shrink-0">
                ...
                <div>
                  <div className="flex justify-between text-[10px] sm:text-xs lg:text-sm mb-1 gap-2">
                    <span className="text-slate-400 truncate">Campaign Completion</span>
                    <span className="font-medium text-white text-[10px] sm:text-xs lg:text-sm flex-shrink-0">
      ...
      {/* Recent Bids Section */}
      {recentBids.length > 0 && (
        <div className="lg:max-w-[66.666667%]">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <h2 className="text-base lg:text-lg font-semibold text-white">Recent Bids on Your Campaigns</h2>
            </CardHeader>
            <CardContent className="p-0">
              <div className="overflow-x-auto">
                <table className="w-full min-w-[500px]">
                  <thead className="bg-slate-900 border-b border-slate-700">
                    <tr>
                      <th className="px-2 sm:px-3 lg:px-4 py-3 text-left text-xs font-medium text-slate-400 uppercase">Influencer</th>
                      <th className="px-2 sm:px-3 lg:px-4 py-3 text-left text-xs font-medium text-slate-400 uppercase">Price</th>
                      <th className="px-2 sm:px-3 lg:px-4 py-3 text-left text-xs font-medium text-slate-400 uppercase hidden sm:table-cell">Delivery</th>
                      <th className="px-2 sm:px-3 lg:px-4 py-3 text-left text-xs font-medium text-slate-400 uppercase">Status</th>
                      <th className="px-2 sm:px-3 lg:px-4 py-3 text-left text-xs font-medium text-slate-400 uppercase hidden md:table-cell">Date</th>
                    </tr>
                  </thead>
                    ...
                    {recentBids.map((bid) => (
                      <tr key={bid.id} className="hover:bg-slate-700/50">
                        <td className="px-2 sm:px-3 lg:px-4 py-3">
                          <div className="flex items-center gap-2 lg:gap-3">
                            <div className="w-8 h-8 rounded-full bg-slate-700 flex items-center justify-center text-slate-300 font-medium text-sm flex-shrink-0">
                        ...
                        <td className="px-2 sm:px-3 lg:px-4 py-3 font-medium text-white text-sm lg:text-base">${bid.proposedPrice}</td>
                        <td className="px-2 sm:px-3 lg:px-4 py-3 text-slate-300 text-sm hidden sm:table-cell">{bid.deliveryDays} days</td>
                        <td className="px-2 sm:px-3 lg:px-4 py-3">{getBidStatusBadge(bid.status)}</td>
                        <td className="px-2 sm:px-3 lg:px-4 py-3 text-slate-400 text-sm hidden md:table-cell">
