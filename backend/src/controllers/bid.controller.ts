...
const checkAndUseCredit = async (userId: string, creditType: 'BID' | 'POST', resourceId: string) => {
  try {
    console.log(`[BID checkAndUseCredit] Checking credit for user ${userId}, type: ${creditType}`);
    ...
    console.log(`[BID checkAndUseCredit] Available ${creditType} credits: ${availableCredits}`);
    ...
    // Deduct credit
    console.log(`[BID checkAndUseCredit] Deducting 1 ${creditType} credit`);
    ...
    console.log(`[BID checkAndUseCredit] Credit deducted successfully. New balance: ${creditType === 'BID' ? newBidCredits : newPostCredits}`);
